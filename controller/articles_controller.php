...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	if($_POST['opt'] == "new"){
		$shopify_data = add_to_shopify($_POST['title'],$_POST['author'],$_POST['tags'], $_POST['content'],$_POST['featured_image'], $_POST["blog_id"], $api_key, $password);
...
function add_to_shopify($title, $author, $tags, $content, $featured_image, $blog_id, $api_key, $password){
	$url = "https://{$api_key}:{$password}@fogocharcoal.myshopify.com/admin/api/2019-07/blogs/{$blog_id}/articles.json";
	$ch = curl_init($url);
